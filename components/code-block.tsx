    ...
    <section id="docs" className="section-shell scroll-mt-20 py-24 sm:py-32" aria-labelledby="integration-title">
      <Reveal className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
        <div>
          ...
          <h2 id="integration-title" className="section-title">Zero Friction ROS Integration.</h2>
          <p className="section-copy">Connect to your leased fleet in seconds. Native support for Python, C++, and ROS 2 Humble. No vendor lock-in.</p>
          ...
          <a href="#intake" className="text-link mt-8">Open API reference <ArrowRight className="size-4" /></a>
        </div>

        <div className="code-window" aria-label="Big Rocket Python SDK example">
          ...
          <div className="code-console"><span>›</span> Authenticated · BR-DOG-01 <b className="flex items-center gap-1"><LockKeyhole className="size-3" /> TLS</b></div>
        </div>
      </Reveal>
    </section>
  );
